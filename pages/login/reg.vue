	...
	>
		...
		<view class="reg-input-box colorwhite"> 
			<view v-for="(item,index) in list" :key="index" class="input-box">
				<input v-if="!item.sendmsgbtn" :value="item.value"  :type="item.inputtype" class="input-item" :placeholder="item.palceholder"  />
				<view v-else class="msg-box-wrap">
					<input class="input-item item-sendmsg" :type="item.inputtype"  :value="item.value" :placeholder="item.palceholder" />
